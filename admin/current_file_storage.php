	...
	<body>
		...
		<div class="display-content">
			<div class="resume-top-left-button">
				...
				<input type="button" value="Current" class="all-btn-top active-buttons" onclick="location.href='current_file_storage.php'">
				
                <input type="button" value="Archive" class="all-btn-top" onclick="location.href='archive_file_storage.php'">
			</div>
            ...
            <div class="">
				<div id="data-table" class="table-display file-width">
					<table class="table-content">
                        ...
                        <tbody>
                            <?php 
                                $get_AllActiveStorage = get_AllActiveStorage();
                            
                                while($row = mysqli_fetch_array($get_AllActiveStorage))
                                {
                            ?>
                                    <tr class='tbl-link'>
