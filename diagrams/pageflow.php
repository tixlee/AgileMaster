    ...
    <section class="content">
	  ...
	  <div class="card shadow mb-4">
			...
			<div class="card-header ">
              <h3 class="m-1 font-weight-bold">Page Flow Diagram Creator</h3>
			  <h5 class="m-1 font-weight-bold">Create A Page Flow Diagram with different types of the shaped provided.</h5>
            </div>
			
			<div id="sample" class="card-body ">
				...
				<div class="form-row">
					<button class="btn btn--radius-2 btn-success" onclick="doCapture();">Save Image</button>
				</div>
			</div>
