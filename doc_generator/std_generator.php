...
<head>
    ...
    <!-- Title Page-->
    <title>STD Document Generator</title>
...
<div class="wrapper">
  ...
  <?php include('../navigation/sidebar_docgenerator.php');?>
	  ...
	  <div class="card shadow mb-4">
		<div class="card-body">
			...
			<div class="card-header py-3">
              <h3 class="m-4 font-weight-bold">STD Document Generator</h3>
			  <h5 class="m-4 font-weight-bold">STD document describes a set of basic software test information that covers test plan, test specification and test report. Test plan prescribes the scope, approach, resource and schedule of the testing activities. Test specification covers the test cases, test procedures and input/output assumptions. Test report identifies the test items, test log and summary report.</h5>
            </div>
                    ...
                    <form method="POST" name="createDoc" id="DocCreator" action="std_report_generator.php" enctype="multipart/form-data">
						...
						<div class="form-row">
							...
							<button class="btn btn--radius-2 btn--blue-2" type="submit" name="send">Generate</button>
						</div>
