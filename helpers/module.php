...
function insert_storage($date_uploaded, $name, $fileName, $document_type, $project_id, $userId)
{
	global $conn;
	$result = mysqli_query($conn, "INSERT INTO `file_storage` (`date_uploaded`, `name`, `file`, `document_type`, `project_id`, `user_id`) VALUES ('$date_uploaded', '$name', '$fileName', '$document_type', '$project_id', '$userId')");
...
function insert_bug_report($bug_name, $bug_desc, $created_by, $assignee, $priority, $state, $due_date, $start_date)
{
	global $conn;
	$result = mysqli_query($conn, "INSERT INTO `bug_report` (`bug_name`, `bug_desc`, `created_by`, `assignee`, `priority`, `state`, `due_date`, `start_date`) VALUES ('$bug_name', '$bug_desc', '$created_by', '$assignee', '$priority', '$state', '$due_date', '$start_date')");
...
function insert_feedback($name, $email, $role, $major, $understanding, $experience, $like_most, $like_least, $attracted, $improve, $new_feature, $rate)
{
	global $conn;
	$result = mysqli_query($conn, "INSERT INTO `feedback_survey` (`name`, `email`, `role`, `major`, `understanding`, `experience`, `like_most`, `like_least`, `attracted`, `improve`, `new_feature`, `rate`) VALUES ('$name', '$email', '$role', '$major', '$understanding', '$experience', '$like_most', '$like_least', '$attracted', '$improve', '$new_feature', '$rate')");
