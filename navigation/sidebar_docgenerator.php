        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
		  ...
		  <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../admin/all_members.php" class="nav-link">
                 &nbsp;&nbsp;&nbsp; <i class="fas fa-users"></i>
                  <p>&nbsp;&nbsp;&nbsp;All Members</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../admin/project_managers.php" class="nav-link">
                  &nbsp;&nbsp;&nbsp; <i class="fas fa-users"></i>
                  <p>&nbsp;&nbsp;&nbsp;Project Manager</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../admin/project_members.php" class="nav-link">
                  &nbsp;&nbsp;&nbsp; <i class="fas fa-users"></i>
                  <p>&nbsp;&nbsp;&nbsp;Project Member</p>
                </a>
              </li>
		  ...
		  <li class="nav-item">
            <a href="../admin/contactus_feedback.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="../admin/upload_files.php" class="nav-link">
